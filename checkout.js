(function () {
    ...
    let order_billing_state = "CA";  
    let order_billing_country = "USA"; 

    /**Payment info */
    let credit_card_type = "visa";
    /**：visa, american_express, master, solo  */ 
    /**：visa, american_express, master, */
    ...
    async function monitor() {
        if (!item_selected) {
            notifyHeader.innerHTML = + refresh_count;
            refresh_count ++;
            let refreshed = false;
